...
module.exports = function(webpackEnv) {
  ...
  return {
    ...
    output: {
      ...(isContainerApp ? {} : { libraryTarget: "commonjs2" }),
      // The build folder.
      ...
      filename: isEnvProduction
        ? isContainerApp ? 'static/js/[name].[contenthash:8].js' : 'static/js/[name].js'
        : isEnvDevelopment && 'static/js/bundle.js',
      // TODO: remove this when upgrading to webpack 5
      futureEmitAssets: true,
      // There are also additional JS chunk files if you use code splitting.
      chunkFilename: isEnvProduction
        ? isContainerApp ? 'static/js/[name].[contenthash:8].chunk.js' : 'static/js/[name].chunk.js'
    ...
    plugins: [
      ...
      isEnvProduction &&
        new MiniCssExtractPlugin({
          ...
          filename: isContainerApp ? 'static/css/[name].[contenthash:8].css' : 'static/css/[name].css',
          chunkFilename: isContainerApp ? 'static/css/[name].[contenthash:8].chunk.css' : 'static/css/[name].chunk.css',
        }),
